...
setblock ~ ~ ~ minecraft:structure_block{mode:"LOAD",name:"uhren-anzeige:v1zahl_0"} replace
...
execute if entity @s[y_rotation=135..-135] run data merge block ~ ~ ~ {rotation:"NONE",posX:-1,posY:0,posZ:0}
execute if entity @s[y_rotation=-135..-45] run data merge block ~ ~ ~ {rotation:"CLOCKWISE_90",posX:0,posY:0,posZ:-1}
execute if entity @s[y_rotation=-45..45] run data merge block ~ ~ ~ {rotation:"CLOCKWISE_180",posX:1,posY:0,posZ:0}
execute if entity @s[y_rotation=45..135] run data merge block ~ ~ ~ {rotation:"COUNTERCLOCKWISE_90",posX:0,posY:0,posZ:1}
